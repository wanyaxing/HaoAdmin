...
(function($, undefined) {
	...
	$.fn.extend({
		...
		offsetOfWinbox:function()
		{
			var offsetWinbox = $(this).winbox().offset();
			var offsetWinbox = $(this).winbox().offset();
			var offsetThis  = $(this).offset();
			return {top:offsetThis.top-offsetWinbox.top+$(this).winbox().scrollTop(),left:offsetThis.left-offsetWinbox.left+$(this).winbox().scrollLeft()}
		},
		isVisible: function() {
		...
		testRemind: function(content, options) {
			...
			// 当前元素的位置，提示框的方向
			var offset = $(this).offsetOfWinbox(), direction = "top";//axing edit
