...
if(!function_exists('___autoloadHaoAdminClassByWanYaXing')) {

    function ___autoloadHaoAdminClassByWanYaXing($p_className) {
        $_dir = '';
    ...
    spl_autoload_register('___autoloadHaoAdminClassByWanYaXing');//自动载入类文件（当用到的类未被引入时，自动引入）
}
